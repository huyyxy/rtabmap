...
def main():
    ...
    # Set RGB-D specific parameters
    params[rtab.Param.kRGBDLinearUpdate] = "0.1"    # 10cm movement threshold
    params[rtab.Param.kRGBDAngularUpdate] = "0.1"   # ~5.7 degree rotation threshold
    ...
    performance_summary = final_stats.getPerformanceSummary()
