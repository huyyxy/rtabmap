#!/usr/bin/env python3
"""
Working RTAB-Map SLAM example using getDefaultParameters().
"""
...
def main():
    ...
    print("=== Working RTAB-Map Python Bindings Example ===\n")
    ...
    # Step 2: Configure parameters using getDefaultParameters
