...
def main():
    ...
    # Step 2: Configure parameters using parseArguments (avoiding recursion issues)
    print("\nStep 2: Configuring parameters...")
    try:
        # Use parseArguments to avoid ParametersMap recursion issues
        args = [
            "--RGBD/Enabled", "true",
            "--Rtabmap/TimeThr", "700",
    ...
    print(f"Init method returned: {init_result}")
    ...
    for i in range(num_frames):
        ...
        # Create sensor data using the static create method
        timestamp = time.time()
        ...
        # Process the frame - use the correct method signature
